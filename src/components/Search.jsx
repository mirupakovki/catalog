  ...
  return (
    <div className={`flex items-center justify-end ${isActiveSearch ? 'w-full flex-1' : ''}`}>
      <input
        className={
          isActiveSearch
            ? 'h-12 w-full flex-1 px-4 outline-0 bg-white dark:bg-gray-800 border-2 border-blue-600 dark:border-gray-600 rounded-xl text-base text-gray-700 dark:text-white transition-all duration-300'
      ...
      <button
        className={
          isActiveSearch
            ? 'w-12 h-12 flex-shrink-0 flex justify-center items-center bg-blue-600 dark:bg-gray-700 rounded-xl cursor-pointer transition-all ml-2'
            : 'w-12 h-12 flex-shrink-0 flex justify-center items-center bg-blue-600 dark:bg-gray-700 rounded-xl cursor-pointer transition-all'
        }
